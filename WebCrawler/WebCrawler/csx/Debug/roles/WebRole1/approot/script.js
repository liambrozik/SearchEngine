...
async function GetStats() {
    while (crawling) {
        await sleep(refresh).then(() => {
            $.ajax({
                type: "POST",
                url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/GetStats",
            ...
            $.ajax({
                type: "POST",
                url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/GetErrors",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
            ...
            $.ajax({
                type: "POST",
                url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/GetLastTenLinks",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
            ...
            $.ajax({
                type: "POST",
                url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/GetQueueCount",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
            ...
            $.ajax({
                type: "POST",
                url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/SearchTrie",
                data: JSON.stringify({ q: "amazon" }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
                    if (msg["d"].length == 0) {
                        $("#is-built").text("Not Built");
                    } else {
                        $("#is-built").text("Built");
                    }
                },
...
$("#ClearQueueConfirm").on("click", function () {
    ...
    $.ajax({
        type: "POST",
        url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/ClearQueue?password=",
...
var canBuild = true;
$("#trie-build").on("click", function () {
    $("#trie-status").text("Building");
    if (canBuild) {
        canBuild = false;
        $.ajax({
            type: "POST",
            url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/downloadWikiTitles",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (msg) {
                $.ajax({
                    type: "POST",
                    url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/BuildTrie",
                    data: JSON.stringify({ fileName: msg["d"] }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
                        $("#trie-count").text(msg["d"][0]);
                        $("#trie-last").text(msg["d"][1]);
                        canBuild = true;
                    },
                    error: function (msg) {
                        console.log(eval(msg));
...
$("#ClearEverythingConfirm").on("click", function () {
    ...
    $.ajax({
        type: "POST",
        url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/ClearTable?password=",
        data: JSON.stringify({ password: pw }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
    ...
    $.ajax({
        type: "POST",
        url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/StopCrawler",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
            Badge(msg["d"]);
    ...
    $.ajax({
        type: "POST",
        url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/ClearErrors",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
            Badge(msg["d"]);
...
$("#title-search-submit").on("click", function () {
    ...
    $.ajax({
        type: "POST",
        url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/GetTitle?q=",
...
$("#CreateNewCrawler").on("click", function () {
    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            $.ajax({
                type: "POST",
                url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/NewCrawler?u=",
            ...
            $.ajax({
                type: "POST",
                url: "http://crawlerstorageacct.cloudapp.net/Admin.asmx/StartCrawler",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
                    Badge(msg["d"]);
